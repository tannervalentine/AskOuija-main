        ...
        <ErrorBoundary style={styles}>
          {(() => {
            if ((gameData !== undefined) && (gameData.status === "playing") && (gameData.questionAsker.uid === auth().currentUser.uid)) {
              return <QuestionAsker styles={styles} GameData={gameData} GameID={gameID} auth={auth().currentUser} Genre={genre} ChangeGenre={changeGenra}  />
            }

            if ((gameData !== undefined) && (gameData.status === "playing") && (gameData.answeringSpirit.uid === auth().currentUser.uid)) {
              return <AnsweringSpirit styles={styles} GameData={gameData} GameID={gameID} Genre={genre} ChangeGenre={changeGenra} />
            }
