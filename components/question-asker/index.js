            ...
            {props.Genre === "" ? (
              ...
              <View style={props.styles.aoLobbyInnerContainer}>
                ...
                <View style={{display: "flex", flexDirection: "column", marginTop: 36, alignItems: "center", justifyContent: "flex-start", width: "100%"}}>
                    <TouchableOpacity style={props.styles.aoQuestionRow} onPress= {() => props.ChangeGenre("Family-friendly")}>
                      <Text style={props.styles.aoQuestionText}>
                        {"Family-friendly"}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={props.styles.aoQuestionRow} onPress= {() => props.ChangeGenre("Office-friendly")}>
                      <Text style={props.styles.aoQuestionText}>
                        {"Office-friendly"}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={props.styles.aoQuestionRow} onPress= {() => props.ChangeGenre("Only-with-friends")}>
                      <Text style={props.styles.aoQuestionText}>
                        {"Only-with-friends"}
                      </Text>
                    </TouchableOpacity>
              ...
              {/*<TouchableOpacity style={props.styles.aoPrimaryButton} onPress = {() => props.setGenre("")}>
              <Text style={props.styles.aoPrimaryButtonText}>
                  {"Change Question Genre"}
                </Text>      
              </TouchableOpacity>*/}
